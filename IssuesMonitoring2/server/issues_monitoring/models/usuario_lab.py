...
class UsuarioLab(Usuario):
    ...
    def salvar_preferencias_ambiente(usuario, laboratorio, tmin, tmax, umin, umax, lmin, lmax):
        db.execute("""INSERT OR REPLACE INTO User_Pref (user_id, lab_id, temp_min, temp_max, umid_min, umid_max, lum_min, lum_max)
                      VALUES (?, ?, ?, ?, ?, ?, ?, ?)""", (usuario, laboratorio, tmin, tmax, umin, umax, lmin, lmax))
